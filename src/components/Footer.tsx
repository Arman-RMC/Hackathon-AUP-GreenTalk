        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          <div>
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="text-xl font-bold">GreenTalk</span>
            </div>
            <p className="text-gray-400 mb-4">
              Making sustainable living effortless through personalized AI assistance.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#problem" className="text-gray-400 hover:text-primary transition-colors">About</a></li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#" className="text-gray-400 hover:text-primary transition-colors">Sustainability Tips</a></li>
              <li><a href="#" className="text-gray-400 hover:text-primary transition-colors">Carbon Calculator</a></li>
          ...
          <div>
            ...
            <p className="text-gray-400 mb-4">
              Stay updated with the latest news and sustainable living tips.
            </p>
            <form className="flex">
              <input 
                type="email" 
        ...
        <div className="border-t border-gray-800 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm">
              © {new Date().getFullYear()} GreenTalk. All rights reserved.
            </p>
